...
break.diff <- t.test(num.books ~ school.break, data=books.week)
```
...
Though it seems that she read more during breaks from school, the difference between the average number of books and pages in weeks in school and on break is not statistically significant (`r clean.t(break.diff)`).
